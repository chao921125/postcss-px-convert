...
const viteFlexibleInject_1 = require("./plugins/viteFlexibleInject");
...
const flexibleScript_1 = require("./plugins/flexibleScript");
Object.defineProperty(exports, "generateFlexibleScript", { enumerable: true, get: function () { return flexibleScript_1.generateFlexibleScript; } });
/**
 * PostCSS 插件工厂函数
 * @param options 插件配置
 * @returns PostCSS 插件
...
function postcssPxConvert(options = { unitToConvert: 'rem' }) {
    ...
    if (options.injectFlexibleScript) {
        (0, flexibleScript_1.generateFlexibleScript)(options.flexibleScriptPath);
    }
    return {
...
if (typeof module !== 'undefined' && typeof module.exports !== 'undefined') {
    ...
    module.exports.generateFlexibleScript = flexibleScript_1.generateFlexibleScript;
}
